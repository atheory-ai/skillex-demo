...
Root guidance is intentionally broad. It is useful for orientation but does not resolve package version, app-local convention, or consumer versus contributor context.
